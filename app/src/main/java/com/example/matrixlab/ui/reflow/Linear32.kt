...
class Linear32 : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_linear32, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Condição para v diferente de zero
        loadLatex(view.findViewById(R.id.math_equacao_caracteristica),
            "\\[ (A - \\lambda I)v = \\mathbf{0} \\]")

        // Determinante nulo
        loadLatex(view.findViewById(R.id.math_det_caracteristico),
