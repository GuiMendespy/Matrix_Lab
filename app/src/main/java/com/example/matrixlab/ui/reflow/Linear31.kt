...
class Linear31 : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_linear31, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Definição de Autovetor: Tv = lambda v
        loadLatex(view.findViewById(R.id.math_def_autovetor),
            "\\[ T(v) = \\lambda v, \\quad v \\neq \\mathbf{0} \\]")

        // Equação Matricial: Av = lambda v
        loadLatex(view.findViewById(R.id.math_equacao_matriz),
            "\\[ A \\cdot v = \\lambda v \\]")
    }
}